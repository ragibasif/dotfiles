" stolen from: https://github.com/zenbones-theme/zenbones.nvim/blob/main/colors/zenwritten.vim
" slightly tweaked version of the original zenwritten
...
if &background ==# 'dark'
    ...
    highlight ColorColumn guifg=NONE guibg=#222222 guisp=NONE gui=NONE cterm=NONE
